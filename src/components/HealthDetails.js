...
const HealthDetails = ({ className = "" }) => {
  ...
  // Separate click handler for Roomify
  const onRoomifyClick = useCallback(() => {
    navigate("/case-study-roomify"); // Navigate to Roomify
  }, [navigate]);

  // Click handler for Flare
  const onFlareClick = useCallback(() => {
    navigate("/case-study-flare"); // Navigate to Flare
  }, [navigate]);

  return (
    <div className={`health-details ${className}`}>
      <div className="roomify-details">
        <div className="roomify-parent" onClick={onRoomifyClick}>
        ...
        <div className="flare-name">
          <div className="group-div" onClick={onFlareClick}>
